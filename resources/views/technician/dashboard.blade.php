    ...
    <div class="px-5 py-6">
        ...
        <div class="mt-8 mb-10 -mx-5 px-5 flex overflow-x-auto no-scrollbar snap-x snap-mandatory gap-4 pb-4">
            ...
            @forelse($tasks as $task)
                <div class="snap-center shrink-0 w-[85vw] max-w-sm rounded-[2rem] bg-gradient-to-b from-[#1a1f26] to-[#0f1217] border border-white/10 p-6 flex flex-col justify-between shadow-2xl relative overflow-hidden" onclick="window.location='{{ route('technician.task.show', $task->id) }}'">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        <div class="bg-black/50 border border-white/5 backdrop-blur-md px-3 py-1.5 rounded-full text-[10px] font-black tracking-widest uppercase flex items-center gap-2">
                            @if($task->priority === 'critical')
