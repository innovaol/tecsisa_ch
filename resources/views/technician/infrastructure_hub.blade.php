<x-technician-layout>
    <div class="px-5 pt-6 max-w-5xl mx-auto md:py-10">
        <!-- Header -->
        <div class="mb-8">
            <h2 class="text-3xl font-black text-white leading-tight">Panel de<br><span class="text-tecsisa-yellow uppercase tracking-widest text-sm font-black">Infraestructura y Catálogo</span></h2>
            <p class="text-xs text-gray-400 font-bold uppercase tracking-widest mt-2 px-1">Gestión Unificada del Sistema</p>
        </div>

        <!-- KPI Grid Rápida -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-white/5 border border-white/10 p-5 rounded-3xl shadow-lg">
            ...
            <div class="hidden md:block bg-white/5 border border-white/10 p-5 rounded-3xl shadow-lg">
                <span class="block text-[9px] font-black text-gray-500 uppercase tracking-tighter mb-1">Sistemas</span>
                <span class="text-2xl font-black text-white">{{ \App\Models\System::count() }}</span>
            </div>
            <div class="hidden md:block bg-white/5 border border-white/10 p-5 rounded-3xl shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <a href="{{ route('technician.equipment.list') }}" class="block group">
                <div class="h-full bg-gradient-to-r from-[#12161f] to-[#0a0d14] border border-white/5 rounded-[2rem] p-6 flex items-center gap-5 hover:border-tecsisa-yellow/30 transition-all active:scale-[0.98] shadow-2xl">
                    ...
                    <div class="flex-1">
                        <h4 class="text-base font-black text-white group-hover:text-tecsisa-yellow transition-colors uppercase tracking-wider">Activos</h4>
            ...
            <a href="{{ route('technician.systems') }}" class="block group">
                <div class="h-full bg-gradient-to-r from-[#12161f] to-[#0a0d14] border border-white/5 rounded-[2rem] p-6 flex items-center gap-5 hover:border-blue-400/30 transition-all active:scale-[0.98] shadow-2xl">
                    ...
                    <div class="flex-1">
                        <h4 class="text-base font-black text-white group-hover:text-blue-400 transition-colors uppercase tracking-wider">Sistemas</h4>
            ...
            <a href="{{ route('technician.locations') }}" class="block group">
                <div class="h-full bg-gradient-to-r from-[#12161f] to-[#0a0d14] border border-white/5 rounded-[2rem] p-6 flex items-center gap-5 hover:border-purple-400/30 transition-all active:scale-[0.98] shadow-2xl">
                    ...
                    <div class="flex-1">
                        <h4 class="text-base font-black text-white group-hover:text-purple-400 transition-colors uppercase tracking-wider">Ubicaciones</h4>
            ...
            <a href="{{ route('rack.builder') }}" class="block group">
                <div class="h-full bg-gradient-to-r from-[#12161f] to-[#0a0d14] border border-white/5 rounded-[2rem] p-6 flex items-center gap-5 hover:border-orange-400/30 transition-all active:scale-[0.98] shadow-2xl">
                    ...
                    <div class="flex-1">
                        <h4 class="text-base font-black text-white group-hover:text-orange-400 transition-colors uppercase tracking-wider">Racks y Puertos</h4>
