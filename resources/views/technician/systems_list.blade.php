<x-technician-layout hideHeader="true">
    <div class="fixed top-0 inset-x-0 z-[60] bg-theme-header backdrop-blur-3xl border-b border-theme pt-safe transition-colors duration-500">
        <div class="px-4 py-4 flex items-center justify-between mx-auto max-w-2xl px-5">
            <a href="{{ route('technician.infrastructure') }}" class="w-11 h-11 flex items-center justify-center bg-theme/5 border border-theme text-theme-muted hover:text-tecsisa-yellow rounded-2xl transition shadow-md active:scale-90 group shrink-0">
