    ...
    <div class="pt-24 px-5 max-w-2xl mx-auto md:py-10 md:px-0">
        <div class="space-y-4">
            @foreach($systems as $sys)
                <div class="bg-gradient-to-r from-[#12161f] to-[#0a0d14] border border-white/5 rounded-2xl p-4 flex flex-col hover:border-tecsisa-yellow/20 transition active:scale-95 shadow-lg group">
                    <div class="flex items-center justify-between w-full relative z-10">
                        <div class="flex items-center gap-4 min-w-0 flex-1">
                            ...
                            <div class="flex-1 min-w-0">
                                <h4 class="text-sm font-black text-white group-hover:text-blue-400 transition truncate">{{ $sys->name }}</h4>
