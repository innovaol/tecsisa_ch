                        ...
                        <tr class="hover:bg-white/[0.02] transition-colors group">
                            ...
                            <td class="px-6 py-3.5 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    @endif
                                     <a href="{{ route('tasks.edit', $task) }}" class="p-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-400 hover:text-white transition tooltip" title="{{ in_array($task->status, ['completed', 'verified']) ? 'Ver Reporte' : 'Editar Reporte' }}">
